(function() {
  ...
  banner.innerHTML = '<span>We use essential cookies to make our services work and analytics cookies to improve your experience. See our <a href="/cookies.html" style="color:#FFAB00;text-decoration:underline;text-underline-offset:2px">Cookie Policy</a> for details.</span>'
    + '<span style="display:flex;gap:10px;flex-shrink:0">'
    + '<button id="cookieReject" style="background:transparent;border:1px solid rgba(255,255,255,0.3);color:rgba(255,255,255,0.85);padding:8px 18px;border-radius:3px;cursor:pointer;font-size:12px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;font-family:Barlow,sans-serif">Reject Non-Essential</button>'
    + '<button id="cookieAccept" style="background:#FF3D00;border:none;color:#0D0D0D;padding:8px 18px;border-radius:3px;cursor:pointer;font-size:12px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;font-family:Barlow,sans-serif">Accept All</button>'
    + '</span>';
